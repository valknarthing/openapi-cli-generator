...
- Input through `stdin` or [CLI shorthand](https://github.com/valknarthing/openapi-cli-generator/tree/master/shorthand)
...
```sh
$ go get -u github.com/valknarthing/openapi-cli-generator
```
